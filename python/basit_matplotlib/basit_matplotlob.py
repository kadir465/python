...
class SimplePlot:
    ...
    def plot_example2(self):
         ...
         plt.bar(katagori, deger, label="Meyve miktarları")#bar , çubuk grafiği oluşturu iki parametreyi de alır burdaki label sayesinde legend da yazzılır
         plt.xlabel("Meyve Türleri")
         plt.ylabel("Miktar")
         plt.title("Meyve Miktarları")
         plt.legend()#legend oluşturur bilgilendirme yazısı gibi neyin ne olduğu 
         plt.savefig("basit_simple2.png")# otomatik ss alır
         plt.show()
    def plot_example3(self):
        ...
        #labels --- pastanın her dilminin adını verir ve legen de yazılır
